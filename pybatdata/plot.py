...
class Plot:
    ...
    Attributes:
        ...
        axis_font_size (int): The font size of the axis labels.
        _fig (go.Figure): The plotly figure.
        x_min (Optional[float]): The minimum x-axis value.
        x_max (Optional[float]): The maximum x-axis value.
        y_min (Optional[float]): The minimum y-axis value.
        y_max (Optional[float]): The maximum y-axis value.
        secondary_y (Optional[str]): The secondary y-axis label.
        y2_min (Optional[float]): The minimum secondary y-axis value.
    ...
    def add_line(
        ...
        if secondary_y is not None:
            ...
            self.add_secondary_y_line(result, x, secondary_y)
        return self

    def add_secondary_y_line(
        self,
        result: "Result",
        x: str,
        y: str,
        ...
        if label is None:
            label = str(result.info["Name"])
        self.check_limits(result.data[x], result.data[y], secondary_y=True)
        self._fig.add_trace(
            go.Scatter(
                x=result.data[x],
                y=result.data[y],
    ...
    def add_secondary_y_legend(self, secondary_y_axis: str) -> None:
