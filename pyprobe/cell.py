...
class Cell(BaseModel):
    ...
    info: Dict[str, Optional[str | int | float | Dict[Any, Any] | datetime]]
    ...
    def check_and_set_name(
        cls, info: Dict[str, Optional[str | int | float | Dict[Any, Any]] | datetime]
    ) -> Dict[str, Optional[str | int | float | Dict[Any, Any]] | datetime]:
